...
<html>
 ...
 ?>
			<form action="modificar_reporteres.php?ID=<?php echo $mostrar['ID']; ?>" method="POST" class="form-regis">
		...
		<div class="contenedor-input">
				...
				<input type="text" name="CORREO" placeholder="Correo" class="input-48" value="<?php echo $mostrar['CORREO'];?>" required>
